...
class DetailedUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.User
        fields = ('id','first_name', 'email', 'profile_picture', 'like_all_count', 'comments_all_count', 'view_all_acount', 'follower_all_acount', 'followed_all_acount', 'is_following', 'subscription_status')
